            ...
            tools: [
                {
                    ...
                    function: {
                        ...
                        description: "Search through the codebase for specific patterns or functionality",
                        parameters: {
                            type: "object",
                            properties: {
                                query: {
                                ...
                                file_pattern: {
                                    type: "string",
                                    description: "File pattern to limit search scope (e.g., *.js, *.py)",
                                },
                            },
                            required: ["query"],
                        },
                ...
                },
                {
                    ...
                    function: {
                        ...
                        description: "Provide context about multiple files and their interactions within the codebase",
                        parameters: {
                            type: "object",
                            properties: {
                                files: {
                                    ...
                                    description: "List of files to analyze for interaction context",
                                },
                            },
                            required: ["files"],
                        },
