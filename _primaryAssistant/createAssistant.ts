...
import { askCodebaseQuestionTool } from "../tools/askCodebaseQuestion/askCodebaseQuestionTool";
...
async function createAssistant(): Promise<
  OpenAI.Beta.Assistants.Assistant | undefined
> {
